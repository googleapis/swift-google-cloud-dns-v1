...
public struct ResponsePolicyRulesListResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  public var responsePolicyRules: [ResponsePolicyRule] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `ResponsePolicyRulesListResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResponsePolicyRulesListResponse().with { $0.nextPageToken = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let responsePolicyRules = CodingKeys(stringValue: "responsePolicyRules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ResponsePolicyRule].self, forKey: .responsePolicyRules)
    {
      self.responsePolicyRules = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.responsePolicyRules, forKey: .responsePolicyRules)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/.ResponsePolicyRulesListResponse"
  }
  ...
  public func _getPaginatedItems() -> [ResponsePolicyRule] {
    return self.responsePolicyRules
  }
