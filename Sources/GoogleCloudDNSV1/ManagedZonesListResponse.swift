...
public struct ManagedZonesListResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  public var managedZones: [ManagedZone] = []
  ...
  /// Initialize a new instance of `ManagedZonesListResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ManagedZonesListResponse().with { $0.kind = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ManagedZone].self, forKey: .managedZones) {
      self.managedZones = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.managedZones, forKey: .managedZones)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/.ManagedZonesListResponse"
  }
