...
extension Clients {
  final class ResponsePolicyRulesTransport: ResponsePolicyRulesStub {
    ...
    public func patch(
      ...
      return try await req.rpc(
        ResponsePolicyRulesPatchResponse.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func update(
      ...
      return try await req.rpc(
        ResponsePolicyRulesUpdateResponse.self, timeout: options.attemptTimeout
      ).get()
    }
  }
}
