...
public struct ManagedZoneDnsSecConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Specifies parameters for generating initial DnsKeys for this ManagedZone. Can only be changed while the state is OFF.
  public var defaultKeySpecs: [DnsKeySpec] = []

  public var kind: Swift.String? = nil

  /// Specifies the mechanism for authenticated denial-of-existence responses. Can only be changed while the state is OFF.
  public var nonExistence: ManagedZoneDnsSecConfig.NonExistence? = nil
  ...
  ///
  /// ```
  /// let value = ManagedZoneDnsSecConfig().with { $0.defaultKeySpecs = ... }
  /// ```
  ...
  public enum NonExistence: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:NonExistence/unknownStringValue(_:)).
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/.ManagedZoneDnsSecConfig"
  }
