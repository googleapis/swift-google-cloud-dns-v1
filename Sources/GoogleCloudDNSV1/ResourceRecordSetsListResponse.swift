...
public struct ResourceRecordSetsListResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  public var rrsets: [ResourceRecordSet] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `ResourceRecordSetsListResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResourceRecordSetsListResponse().with { $0.kind = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rrsets = CodingKeys(stringValue: "rrsets")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ResourceRecordSet].self, forKey: .rrsets) {
      self.rrsets = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.rrsets, forKey: .rrsets)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/.ResourceRecordSetsListResponse"
  }
  ...
  public func _getPaginatedItems() -> [ResourceRecordSet] {
    return self.rrsets
  }
