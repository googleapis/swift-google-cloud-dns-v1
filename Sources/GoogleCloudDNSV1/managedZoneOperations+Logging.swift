...
extension Clients {
  final class ManagedZoneOperationsLogging: ManagedZoneOperationsStub {
    let inner: any ManagedZoneOperationsStub
    let logger: Logger

    public init(_ inner: any ManagedZoneOperationsStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = ""
      logger[metadataKey: "gcp.client.service"] = "dns"
      logger[metadataKey: "gcp.experimental.swift.client"] = "ManagedZoneOperations"
      self.inner = inner
      self.logger = logger
    }
