...
public struct GoogleIamV1TestIamPermissionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GoogleIamV1TestIamPermissionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoogleIamV1TestIamPermissionsResponse().with { $0.permissions = ... }
  /// ```
