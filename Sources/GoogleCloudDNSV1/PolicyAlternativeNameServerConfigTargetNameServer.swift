...
public struct PolicyAlternativeNameServerConfigTargetNameServer: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  /// Forwarding path for this TargetNameServer. If unset or set to DEFAULT, Cloud DNS makes forwarding decisions based on address ranges; that is, RFC1918 addresses go to the VPC network, non-RFC1918 addresses go to the internet. When set to PRIVATE, Cloud DNS always sends queries through the VPC network for this target.
  public var forwardingPath: PolicyAlternativeNameServerConfigTargetNameServer.ForwardingPath? = nil
  ...
  ///
  /// ```
  /// let value = PolicyAlternativeNameServerConfigTargetNameServer().with { $0.forwardingPath = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/.PolicyAlternativeNameServerConfigTargetNameServer"
  }
