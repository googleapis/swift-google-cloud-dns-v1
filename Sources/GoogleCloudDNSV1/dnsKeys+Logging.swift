...
extension Clients {
  final class DnsKeysLogging: DnsKeysStub {
    let inner: any DnsKeysStub
    let logger: Logger

    public init(_ inner: any DnsKeysStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = ""
      logger[metadataKey: "gcp.client.service"] = "dns"
      logger[metadataKey: "gcp.experimental.swift.client"] = "DnsKeys"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func `get`(
      ...
      try await self._intercept(
        ...
        name: "`get`",
        action: {
          (r: DnsKeysClient.GetRequest, o: GoogleCloudGax.RequestOptions) async throws -> DnsKey
          in
    ...
    public func list(
      ...
      try await self._intercept(
        ...
        name: "list",
        action: {
          (r: DnsKeysClient.ListRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> DnsKeysListResponse
          in
